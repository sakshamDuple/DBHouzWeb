...
function MerchantList() {
  ...
  const handleStatusChange = async (merchant) => {
    ...
    await RestAdmin.updateMerchant({
      ...merchant,
      status: merchant.status == "INACTIVE" ? "ACTIVE" : "INACTIVE",
    });
                  ...
                  <div className="row align-items-center justify-content-center pb-20 hdngRowBlk">
                    ...
                    <div className="col-auto">
                      <div className="addPrdctBtn">
                        <Link to="/admin/addmerchant" className="btnCommon">
                          <span>
                          ...
                          {merchants.map((merchant, index) => {
                            return (
                              <tr className="whitebgRow">
                                ...
                                <td>
                                  <div className="">{merchant.email}</div>
                                </td>
