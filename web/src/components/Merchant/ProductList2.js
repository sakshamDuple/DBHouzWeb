...
import AdNavBar from "../Admin/NavBar";
...
function AdminProductList() {
  ...
  const editProductVariantsBtnAction = (product) => {
    navigate("/merchant/EditProductVariants", { state: { product } });
  };
                            ...
                            <tr className="whitebgRow">
                              ...
                              <td className="text-center">
                                <div className="prdctImg text-center">
                                  ...
                                  {product.images.length > 0 && product.images[0] && (
                                    <img
                                      src={
                                        Rest + "/documents/get/" + product.images[0].documentId
                                      }
                                      alt=""
                                      width="80"
                                      height="80"
                              ...
                              <td className="text-center">
                                <button
                                  ...
                                  onClick={() => {
                                    editProductVariantsBtnAction(product);
                                  }}
                                >
                                  {product.variants.length}
                                  <span className="ms-2">
                                    <img src={editWhite} alt="" height="12" />
                                  </span>
                                </button>
                              </td>
                              <td className="text-center">
                                  ...
                                  <ul>
                                    <li className="view-btn">
                                      <div className="">
                                        <a href="/merchant/viewproduct">
                                          ...
                                          <span>
                                            <img src={viewWhite} alt="" height="18" />
                                          </span>
                                        </a>
                                      </div>
                                    </li>
                                    <li className="edit-btn">
                                      <div
                                        className=""
                                        onClick={() => {
                                          editProductBtnAction(product);
                                        }}
                                      >
                                        <a>
                                          <img src={editIcon} alt="" height="18" />
                                          <span>
                                            <img src={editWhite} alt="" height="18" />
                                          </span>
                                        </a>
                                      </div>
                                    </li>
