...
function TransactionList() {
    ...
    const getProducts = async () => {
        try {
            ...
            const res = await axios.get(`/order/getTransactionMerchant/action?Merchant=${sellerId}&TransactionMethod=${selectOption}&page=${currentPage}&limit=${limit}&TransactionStatus=${selectOrderOption}`);
