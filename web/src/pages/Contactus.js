...
function Contactus() {
  ...
  return (
    <section className="wrapper">
          ...
          <div className="contactOuterDiv">
            ...
            <div className="row mt-5 pt-4">
              <div className="col-sm-5">
                <div className="contact__info  mt-3">
                  <div className="contact__info--items">
                    <h4 className="contact__info--content__title text-white mb-3">
                      Contact Us
                    </h4>
                  ...
                  <div className="contact__info--items">
                    <h4 className="contact__info--content__title text-white mb-15">
                      Follow Us
                    </h4>
      ...
      <article className="wrapper mt-4">
        <div className="mapIframeBlk">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15280114.312265644!2d73.72997399968845!3d20.77118574818321!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30635ff06b92b791%3A0xd78c4fa1854213a6!2sIndia!5e0!3m2!1sen!2sin!4v1652155991818!5m2!1sen!2sin"
            allowfullscreen=""
            loading="lazy"
          ></iframe>
        </div>
