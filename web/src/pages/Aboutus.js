...
function Aboutus() {
  ...
  return (
    <section className="wrapper">
      ...
      <article className="wrapper aboutUsBlk mb-5">
        <div className="container">
          <div className="row">
            <div className="col-xl-6">
              <div className="about-one__img">
                <div className="shape1 zoom-fade">
                  <img src="img/about-v1-shape1.png" alt="" />
                </div>
              ...
              <div className="about-one__content">
                <div className="sec-title">
                  ...
                  <h2 className="sec-title__title">
                    DB Houz Marbles and natural <br /> stones
                  </h2>
                </div>
                ...
                <div className="about-two__content-text2">
                  ...
                  <p>
                    ...
                    standard dummy text ever since the 1500s, when an unknown
                    printer took a galley of type and scrambled it to make a
                    type specimen book. Amet aliquam cenas ultricies. Facilisis
                    sed odio morbi quis magnis
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container">
          <div className="benifitMarbleInfo">
            ...
            <p>
              ...
              industry. Lorem Ipsum has been the industry's standard dummy text
              ever since the 1500s, when an unknown printer took a galley of
              type and scrambled it versions of Lorem Ipsum.
            </p>
          </div>
        </div>
      </article>
