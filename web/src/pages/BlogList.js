              ...
              <div className="newsSlideItem">
                <Link to="/blogdetail">
                  <div className="newsSlideMedia">
                    <div
                      className="newsImg"
                      style={{ backgroundImage: `url("img/blog1.png")` }}
                    >
                  ...
                  <div className="newsTitle">
                    <h4>
                      Eeiusmod tempor incididunt ut labore et dolore magna
                      aliqua.
                    </h4>
                  </div>
                  <div className="newsInfo">
                    <p>
                      Interdum odio orci, fringilla nec dolor et, euismod auctor
                      mauris. Curabitur semper dui diam, nec accumsan mauris
                      consequat sed. Interdum et malesuada fames
                    </p>
                  </div>
                </Link>
              </div>
              ...
              <div className="newsSlideItem">
                <Link to="/blogdetail">
                  <div className="newsSlideMedia">
                    <div
                      className="newsImg"
                      style={{ backgroundImage: `url("img/blog2.png")` }}
                    >
                      <div className="newsOverlay"></div>
                    </div>
                    <span className="newsDate">28</span>
              ...
              <div className="newsSlideItem">
                <Link to="/blogdetail">
                  <div className="newsSlideMedia">
                    <div
                      className="newsImg"
                      style={{ backgroundImage: `url("img/blog3.png")` }}
                    >
                      <div className="newsOverlay"></div>
                    </div>
                    <span className="newsDate">28</span>
